...
class TestSmtpCredentials(TestCase):
    ...
    def test_expecting_success(self) -> None:
        ...
        self.assertEqual(
            (status, message), (True, smtpcheck.Messages.SUCCESS.value))
    ...
    def test_expecting_SMTP_connection_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.SMTP_CONNECTION_ERROR.value))
    ...
    def test_expecting_general_connection_refused_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.CONNECTION_REFUSED_ERROR.value))
    ...
    def test_expecting_SMTP_helo_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.HELO_OR_EHLO_ERROR.value))
    ...
    def test_expecting_SMTP_server_disconnected_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.DISCONNECTION_ERROR.value))
    ...
    def test_expecting_SMTP_authentication_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.AUTHENTICATION_ERROR.value))
    ...
    def test_expecting_general_SMTP_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.UNKNOWN_SMTP_ERROR.value))
    ...
    def test_expecting_general_error(self) -> None:
        ...
        self.assertEqual(
            (status, message), (False, smtpcheck.Messages.UNKNOWN_ERROR.value))
